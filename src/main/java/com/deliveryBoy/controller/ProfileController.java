...
public class ProfileController {
     ...
     @RequestParam(value="profilephoto",required=false)
	   MultipartFile profilephoto
		...
		try {
			...
			return ResponseEntity.ok(SuccessResponse.builder()
    			    .message("Data could't saved properly!")
	...
	public ResponseEntity<SuccessResponse>updateProfilePhoto(
		...
		try {
			...
			return ResponseEntity.ok(SuccessResponse.builder()
				...
				return ResponseEntity.ok(SuccessResponse.builder()
	    			    .message("update couldn't successfull.")
	    			    .status(HttpStatus.INTERNAL_SERVER_ERROR)
	    			    .timeStamp(LocalDateTime.now())
	    			    .build());
	...
	public ResponseEntity<SuccessResponse> updateProfile(@PathVariable Long userId,@RequestBody ProfileEntity profileEntity){
